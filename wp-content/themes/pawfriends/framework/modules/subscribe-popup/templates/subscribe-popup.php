        ...
        <div class="mkdf-sp-table-cell">
            <div class="mkdf-sp-inner">
	            ...
	            <?php if ( ! empty( $background_styles ) ) { ?>
		            <div class="mkdf-sp-background" <?php pawfriends_mikado_inline_style( $background_styles ); ?>></div>
	            <?php } ?>
                <div class="mkdf-sp-content-container">
	                <?php if ( ! empty( $title ) ) { ?>
		                <h3 class="mkdf-sp-title"><?php echo esc_html( $title ); ?></h3>
	                <?php } ?>
	                ...
	                <?php if ( $enable_prevent === 'yes' ) { ?>
		                <div class="mkdf-sp-prevent">
			                <div class="mkdf-sp-prevent-inner">
				                ...
				                <label class="mkdf-sp-prevent-label"><?php esc_html_e( 'Prevent This Pop-up', 'pawfriends' ); ?></label>
			                </div>
		                </div>
	                <?php } ?>
                </div>
