<?php
$blog_single_navigation = pawfriends_mikado_options()->getOptionValue('blog_single_navigation') === 'no' ? false : true;
$blog_navigation_through_same_category = pawfriends_mikado_options()->getOptionValue('blog_navigation_through_same_category') === 'no' ? false : true;
?>
		...
		<div class="mkdf-blog-single-navigation-inner clearfix">
			<?php
				...
				$post_navigation = array(
					'prev' => array(
						'mark' => '<span class="mkdf-blog-single-nav-mark">&lt;</span>',
						'label' => '<span class="mkdf-blog-single-nav-label">'.esc_html__('Previous', 'pawfriends').'</span>'
					),
					'next' => array(
						'mark' => '<span class="mkdf-blog-single-nav-mark">&gt;</span>',
						'label' => '<span class="mkdf-blog-single-nav-label">'.esc_html__('Next', 'pawfriends').'</span>'
					)
				);
