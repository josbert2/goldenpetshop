...
if ( ! function_exists('pawfriends_mikado_contact_form_7_options_map') ) {

	function pawfriends_mikado_contact_form_7_options_map() {
		
		pawfriends_mikado_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'pawfriends' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = pawfriends_mikado_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'pawfriends' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = pawfriends_mikado_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'pawfriends' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'pawfriends' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = pawfriends_mikado_add_admin_row(
			array(
		...
		pawfriends_mikado_add_admin_field(array(
			...
			'default_value' => '',
			'label'         => esc_html__( 'Placeholder Text Color', 'pawfriends' ),
		));
		...
		pawfriends_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'pawfriends' ),
			)
		);
		...
		$typography_text_row2 = pawfriends_mikado_add_admin_row(
			array(
		...
		$typography_text_row3 = pawfriends_mikado_add_admin_row(
			array(
		...
		$typography_label_group = pawfriends_mikado_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'pawfriends' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'pawfriends' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = pawfriends_mikado_add_admin_row(
			array(
		...
		$typography_label_row2 = pawfriends_mikado_add_admin_row(
			array(
		...
		$background_border_group = pawfriends_mikado_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'pawfriends' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'pawfriends' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = pawfriends_mikado_add_admin_row(
			array(
		...
		pawfriends_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'pawfriends' )
			)
		);
		...
		pawfriends_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'pawfriends' )
			)
		);
		
		$background_border_row2 = pawfriends_mikado_add_admin_row(
			array(
		...
		pawfriends_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'pawfriends' )
			)
		);
		...
		pawfriends_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'pawfriends' )
			)
		);
		
		$background_border_row3 = pawfriends_mikado_add_admin_row(
			array(
		...
		pawfriends_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'pawfriends' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = pawfriends_mikado_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'pawfriends' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = pawfriends_mikado_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		pawfriends_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'pawfriends' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		pawfriends_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'pawfriends' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		pawfriends_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'pawfriends' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		pawfriends_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'pawfriends' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = pawfriends_mikado_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'pawfriends' ),
				'description' => esc_html__( 'Setup form elements margin', 'pawfriends' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = pawfriends_mikado_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		pawfriends_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top', 'pawfriends' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		pawfriends_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom', 'pawfriends' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		pawfriends_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'pawfriends' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'pawfriends' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = pawfriends_mikado_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'pawfriends' ),
				'description' => esc_html__( 'Setup button text typography', 'pawfriends' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = pawfriends_mikado_add_admin_row(
			array(
		...
		pawfriends_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Hover Text Color', 'pawfriends' )
			)
		);
		...
		$button_typography_row2 = pawfriends_mikado_add_admin_row(
			array(
		...
		$button_background_border_group = pawfriends_mikado_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'pawfriends' ),
				'description' => esc_html__( 'Setup button background and border style', 'pawfriends' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = pawfriends_mikado_add_admin_row(
			array(
		...
		pawfriends_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'pawfriends' )
			)
		);
		...
		pawfriends_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'pawfriends' )
			)
		);
		
		$button_background_border_row2 = pawfriends_mikado_add_admin_row(
			array(
		...
		pawfriends_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'pawfriends' )
			)
		);
		...
		pawfriends_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'pawfriends' )
			)
		);
		
		$button_background_border_row3 = pawfriends_mikado_add_admin_row(
			array(
		...
		pawfriends_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'pawfriends' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		pawfriends_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'pawfriends' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = pawfriends_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'pawfriends')
		));

		//Text Typography

		$typography_text_group = pawfriends_mikado_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'pawfriends'),
			'description'	=> esc_html__('Setup typography for form elements text', 'pawfriends'),
		...
		$typography_text_row1 = pawfriends_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = pawfriends_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = pawfriends_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = pawfriends_mikado_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'pawfriends'),
			'description'	=> esc_html__('Setup typography for form elements label', 'pawfriends'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = pawfriends_mikado_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = pawfriends_mikado_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = pawfriends_mikado_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'pawfriends'),
			'description'	=> esc_html__('Setup form elements background and border style', 'pawfriends'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = pawfriends_mikado_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = pawfriends_mikado_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = pawfriends_mikado_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = pawfriends_mikado_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'pawfriends'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = pawfriends_mikado_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = pawfriends_mikado_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'pawfriends'),
			'description'	=> esc_html__('Setup form elements margin', 'pawfriends'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = pawfriends_mikado_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = pawfriends_mikado_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'pawfriends'),
			'description'	=> esc_html__('Setup button text typography', 'pawfriends'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = pawfriends_mikado_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = pawfriends_mikado_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = pawfriends_mikado_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'pawfriends'),
			'description'	=> esc_html__('Setup button background and border style', 'pawfriends'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = pawfriends_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = pawfriends_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = pawfriends_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = pawfriends_mikado_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'pawfriends')
        ));
        ...
        $typography_label_row3 = pawfriends_mikado_add_admin_row(array(
        ...
        $button_typography_row3 = pawfriends_mikado_add_admin_row(array(
	...
	add_action( 'pawfriends_mikado_action_options_map', 'pawfriends_mikado_contact_form_7_options_map', pawfriends_mikado_set_options_map_position( 'contact_form_7' ) );
}