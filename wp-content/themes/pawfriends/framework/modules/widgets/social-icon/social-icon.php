...
if ( class_exists( 'PawFriendsCoreClassWidget' ) ) {
	class PawFriendsMikadoClassSocialIconWidget extends PawFriendsCoreClassWidget {
		
		public function __construct() {
			parent::__construct(
				'mkdf_social_icon_widget',
				esc_html__( 'PawFriends Social Icon Widget', 'pawfriends' ),
				array( 'description' => esc_html__( 'Add social network icons to widget areas', 'pawfriends' ) )
			);
			...
			$this->params = array_merge(
				array(
					array(
						'type'        => 'dropdown',
						'name'        => 'icon_text',
						'title'       => esc_html__( 'Display Icon or Text', 'pawfriends' ),
						'description' => esc_html__( 'Choose whether you want to display social icon or text instead', 'pawfriends' ),
						'options'     => array(
							'icon' => esc_html__( 'Icon', 'pawfriends' ),
							'text' => esc_html__( 'Text', 'pawfriends' )
						)
					),
					array(
						'type'        => 'textfield',
						'name'        => 'social_text',
						'title'       => esc_html__( 'Social Text', 'pawfriends' ),
						'description' => esc_html__( 'Instert text which will describe desired social network', 'pawfriends' )
					)
				),
				pawfriends_mikado_icon_collections()->getSocialIconWidgetParamsArray(),
				array(
					array(
						'type'  => 'textfield',
						'name'  => 'link',
