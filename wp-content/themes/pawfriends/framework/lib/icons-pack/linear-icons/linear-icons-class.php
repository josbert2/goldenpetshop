...
if ( ! function_exists( 'pawfriends_mikado_add_linear_icon_pack' ) ) {
	function pawfriends_mikado_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new PawFriendsMikadoClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'pawfriends_mikado_filter_add_icon_pack_into_collection', 'pawfriends_mikado_add_linear_icon_pack' );
}

if ( ! function_exists( 'pawfriends_mikado_add_linear_icon_pack_option' ) ) {
	function pawfriends_mikado_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'pawfriends' );
		
		return $options;
	}
	
	add_filter( 'pawfriends_mikado_filter_add_icon_pack_into_options', 'pawfriends_mikado_add_linear_icon_pack_option' );
}

class PawFriendsMikadoClassLinearIcons implements iPawFriendsMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
