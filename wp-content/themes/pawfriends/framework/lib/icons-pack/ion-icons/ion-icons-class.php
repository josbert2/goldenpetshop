...
if ( ! function_exists( 'pawfriends_mikado_add_ion_icon_pack' ) ) {
	function pawfriends_mikado_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new PawFriendsMikadoClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'pawfriends_mikado_filter_add_icon_pack_into_collection', 'pawfriends_mikado_add_ion_icon_pack' );
}

if ( ! function_exists( 'pawfriends_mikado_add_ion_icon_pack_option' ) ) {
	function pawfriends_mikado_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'pawfriends' );
		
		return $options;
	}
	
	add_filter( 'pawfriends_mikado_filter_add_icon_pack_into_options', 'pawfriends_mikado_add_ion_icon_pack_option' );
	add_filter( 'pawfriends_mikado_filter_add_icon_pack_into_social_options', 'pawfriends_mikado_add_ion_icon_pack_option' );
}

class PawFriendsMikadoClassIonIcons implements iPawFriendsMikadoInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
