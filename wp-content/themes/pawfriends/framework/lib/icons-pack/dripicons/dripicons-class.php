...
if ( ! function_exists( 'pawfriends_mikado_add_dripicons_icon_pack' ) ) {
	function pawfriends_mikado_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new PawFriendsMikadoClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'pawfriends_mikado_filter_add_icon_pack_into_collection', 'pawfriends_mikado_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'pawfriends_mikado_add_dripicons_icon_pack_option' ) ) {
	function pawfriends_mikado_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'pawfriends' );
		
		return $options;
	}
	
	add_filter( 'pawfriends_mikado_filter_add_icon_pack_into_options', 'pawfriends_mikado_add_dripicons_icon_pack_option' );
}

class PawFriendsMikadoClassDripicons implements iPawFriendsMikadoInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
