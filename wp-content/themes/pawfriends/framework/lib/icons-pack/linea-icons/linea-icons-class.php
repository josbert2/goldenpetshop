...
if ( ! function_exists( 'pawfriends_mikado_add_linea_icon_pack' ) ) {
	function pawfriends_mikado_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new PawFriendsMikadoClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'pawfriends_mikado_filter_add_icon_pack_into_collection', 'pawfriends_mikado_add_linea_icon_pack' );
}

if ( ! function_exists( 'pawfriends_mikado_add_linea_icon_pack_option' ) ) {
	function pawfriends_mikado_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'pawfriends' );
		
		return $options;
	}
	
	add_filter( 'pawfriends_mikado_filter_add_icon_pack_into_options', 'pawfriends_mikado_add_linea_icon_pack_option' );
}

class PawFriendsMikadoClassLineaIcons implements iPawFriendsMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
