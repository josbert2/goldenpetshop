...
if ( ! function_exists( 'pawfriends_mikado_add_simple_line_icon_pack' ) ) {
	function pawfriends_mikado_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new PawFriendsMikadoClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'pawfriends_mikado_filter_add_icon_pack_into_collection', 'pawfriends_mikado_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'pawfriends_mikado_add_simple_line_icon_pack_option' ) ) {
	function pawfriends_mikado_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'pawfriends' );
		
		return $options;
	}
	
	add_filter( 'pawfriends_mikado_filter_add_icon_pack_into_options', 'pawfriends_mikado_add_simple_line_icon_pack_option' );
	add_filter( 'pawfriends_mikado_filter_add_icon_pack_into_social_options', 'pawfriends_mikado_add_simple_line_icon_pack_option' );
}

class PawFriendsMikadoClassSimpleLineIcons implements iPawFriendsMikadoInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'pawfriends'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'pawfriends'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'pawfriends'),
            'icon-social-facebook'    => esc_html__('Facebook', 'pawfriends'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'pawfriends'),
            'icon-social-github'      => esc_html__('Github', 'pawfriends'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'pawfriends'),
            'icon-social-instagram'   => esc_html__('Instagram', 'pawfriends'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'pawfriends'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'pawfriends'),
            'icon-social-reddit'      => esc_html__('Reddit', 'pawfriends'),
            'icon-social-skype'       => esc_html__('Skype', 'pawfriends'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'pawfriends'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'pawfriends'),
            'icon-social-spotify'     => esc_html__('Spotify', 'pawfriends'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'pawfriends'),
            'icon-social-twitter'     => esc_html__('Twitter', 'pawfriends'),
            'icon-social-youtube'     => esc_html__('Youtube', 'pawfriends')
        );
    }
