...
if ( ! function_exists( 'pawfriends_mikado_add_font_awesome_icon_pack' ) ) {
	function pawfriends_mikado_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new PawFriendsMikadoClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'pawfriends_mikado_filter_add_icon_pack_into_collection', 'pawfriends_mikado_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'pawfriends_mikado_add_font_awesome_icon_pack_option' ) ) {
	function pawfriends_mikado_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'pawfriends' );
		
		return $options;
	}
	
	add_filter( 'pawfriends_mikado_filter_add_icon_pack_into_options', 'pawfriends_mikado_add_font_awesome_icon_pack_option' );
	add_filter( 'pawfriends_mikado_filter_add_icon_pack_into_social_options', 'pawfriends_mikado_add_font_awesome_icon_pack_option' );
}

class PawFriendsMikadoClassIconsFontAwesome implements iPawFriendsMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
