...
if ( ! function_exists( 'pawfriends_mikado_add_font_elegant_icon_pack' ) ) {
	function pawfriends_mikado_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new PawFriendsMikadoClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'pawfriends_mikado_filter_add_icon_pack_into_collection', 'pawfriends_mikado_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'pawfriends_mikado_add_font_elegant_icon_pack_option' ) ) {
	function pawfriends_mikado_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'pawfriends' );
		
		return $options;
	}
	
	add_filter( 'pawfriends_mikado_filter_add_icon_pack_into_options', 'pawfriends_mikado_add_font_elegant_icon_pack_option' );
	add_filter( 'pawfriends_mikado_filter_add_icon_pack_into_social_options', 'pawfriends_mikado_add_font_elegant_icon_pack_option' );
}

class PawFriendsMikadoClassIconsFontElegant implements iPawFriendsMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
