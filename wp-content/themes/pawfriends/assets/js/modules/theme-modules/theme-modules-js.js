	...
	function mkdfInitBlogPagination(){
		...
		var initMainPagFunctionality = function(thisHolder) {
			...
			if(nextPage <= maxNumPages){
				...
				var ajaxData = mkdf.modules.common.setLoadMoreAjaxData(loadMoreDatta, 'pawfriends_mikado_blog_load_more');
    ...
    function mkdfInitBlogListShortcodePagination(){
        ...
        var initMainPagFunctionality = function(thisHolder, pagedLink) {
            ...
            if(nextPage <= maxNumPages){
                ...
                var ajaxData = mkdf.modules.common.setLoadMoreAjaxData(loadMoreDatta, 'pawfriends_mikado_blog_shortcode_load_more');
