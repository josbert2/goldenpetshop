...
/**
 * Class PawFriendsInstagramHelper
 */
class PawFriendsInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines pawfriends_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image, $imageSize ) {
		...
		$imageAtts = apply_filters( 'pawfriends_instagram_image_atts',
			array(
				'class'  => $imageSize,
