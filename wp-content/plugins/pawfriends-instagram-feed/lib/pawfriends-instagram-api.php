...
include 'pawfriends-instagram-helper.php';

/**
 * Class PawFriendsInstagramApi
 */
class PawFriendsInstagramApi {
	/**
	...
	private $apiURL;
	/**
	 * @var PawFriendsInstagramApi instance of current class
	 */
	private static $instance;
	
	/**
	 * Helper object
	 * @var PawFriendsInstagramHelper
	 */
	private $helper;
	
	const CODE_OPTION_NAME = 'pawfriends_instagram_code';
	const USER_ID_OPTION_NAME = 'pawfriends_instagram_user_id';
	const ACCESS_TOKEN_OPTION_NAME = 'pawfriends_instagram_access_token';
	const CODE_REDIRECT_URI_OPTION_NAME = 'pawfriends_instagram_code_redirect_uri';
	...
	public function __construct() {
		...
		$this->redirectUri  = defined( 'MIKADO_PROFILE_SLUG' ) ? 'http://demo.' . MIKADO_PROFILE_SLUG . '-themes.com/instagram-app/instagram-redirect.php' : '';
		...
		$this->helper       = new PawFriendsInstagramHelper();
	}
	 ...
	 * @return string
	 *
	 * @see PawFriendsInstagramApi::buildCurrentPageURI()
	 */
	...
	/**
	 * @return PawFriendsInstagramHelper
	 */
	 ...
	 *
	 * @see PawFriendsInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see PawFriendsInstagramApi::getAccessToken()
	 */
	private function fetchData( $limit = '', $transient = array( 'use_transient' => false ) ) {
		...
		if ( $this->useTransients( $transient ) && get_transient( $transient['transient_name'] ) ) {
			...
			if(isset( $httpBody['meta']['code'] ) && $httpBody['meta']['code'] !== 200 ) {
                $returnObject->status  = 'error';
                $returnObject->message = 'Can\'t connect with Instagram';
