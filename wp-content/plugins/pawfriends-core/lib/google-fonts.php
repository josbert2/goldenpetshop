<?php
if ( ! function_exists( 'pawfriends_mikado_init_google_fonts_array' ) ) {
    function pawfriends_mikado_init_google_fonts_array() {
...
';
        ...
        $pawfriends_mikado_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'pawfriends_mikado_init_google_fonts_array');
}