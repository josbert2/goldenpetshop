...
class PortfolioSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Slider', 'pawfriends-core' ),
					'base'     => $this->base,
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Items', 'pawfriends-core' ),
							'admin_label' => true,
							'description' => esc_html__( 'Set number of items for your portfolio slider. Enter -1 to show all', 'pawfriends-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Number of portfolios that are showing at the same time in slider (on smaller screens is responsive so there will be less items shown). Default value is Four', 'pawfriends-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Set image proportions for your portfolio slider.', 'pawfriends-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Navigation Skin', 'pawfriends-core' ),
							'value'      => array(
								esc_html__( 'Default', 'pawfriends-core' ) => '',
								esc_html__( 'Light', 'pawfriends-core' )   => 'light',
								esc_html__( 'Dark', 'pawfriends-core' )    => 'dark'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Pagination Skin', 'pawfriends-core' ),
							'value'      => array(
								esc_html__( 'Default', 'pawfriends-core' ) => '',
								esc_html__( 'Light', 'pawfriends-core' )   => 'light',
								esc_html__( 'Dark', 'pawfriends-core' )    => 'dark'
						...
						array(
							...
							'heading'     => esc_html__( 'Pagination Position', 'pawfriends-core' ),
							'value'       => array(
								esc_html__( 'Below Slider', 'pawfriends-core' ) => 'below-slider',
								esc_html__( 'On Slider', 'pawfriends-core' )    => 'on-slider'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'enable_pagination', 'value' => array( 'yes' ) ),
							'group'       => esc_html__( 'Slider Settings', 'pawfriends-core' )
