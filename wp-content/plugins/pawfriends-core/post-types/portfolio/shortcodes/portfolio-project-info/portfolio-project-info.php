...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Project Info', 'pawfriends-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'pawfriends-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
							'description' => esc_html__( 'If you left this field empty then project ID will be of the current page', 'pawfriends-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'project_info_type',
							'heading'     => esc_html__( 'Project Info Type', 'pawfriends-core' ),
							'value'       => array(
								esc_html__( 'Title', 'pawfriends-core' )          => 'title',
								esc_html__( 'Category', 'pawfriends-core' )       => 'category',
								esc_html__( 'Tag', 'pawfriends-core' )            => 'tag',
								esc_html__( 'Author', 'pawfriends-core' )         => 'author',
								esc_html__( 'Date', 'pawfriends-core' )           => 'date',
								esc_html__( 'Featured Image', 'pawfriends-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Project Title Tag', 'pawfriends-core' ),
							'value'       => array_flip( pawfriends_mikado_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'description' => esc_html__( 'Set title tag for project title element', 'pawfriends-core' ),
							'dependency'  => array( 'element' => 'project_info_type', 'value' => array( 'title' ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'project_info_title',
							'heading'     => esc_html__( 'Project Info Label', 'pawfriends-core' ),
							'description' => esc_html__( 'Add project info label before project info element/s', 'pawfriends-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'project_info_title_tag',
							'heading'    => esc_html__( 'Project Info Label Tag', 'pawfriends-core' ),
							'value'      => array_flip( pawfriends_mikado_get_title_tag( true, array( 'p' => 'p' ) ) ),
