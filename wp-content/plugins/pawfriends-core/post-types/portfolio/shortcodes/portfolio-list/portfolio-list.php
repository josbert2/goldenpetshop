...
namespace PawFriendsCore\CPT\Shortcodes\Portfolio;
...
class PortfolioList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map( array(
					'name'     => esc_html__( 'Portfolio List', 'pawfriends-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Portfolio List Template', 'pawfriends-core' ),
							'value'       => array(
								esc_html__( 'Gallery', 'pawfriends-core' ) => 'gallery',
								esc_html__( 'Masonry', 'pawfriends-core' ) => 'masonry'
							),
							'save_always' => true,
							'admin_label' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Click Behavior', 'pawfriends-core' ),
							'value'      => array(
								esc_html__( 'Open portfolio single page on click', 'pawfriends-core' )   => '',
								esc_html__( 'Open gallery in Pretty Photo on click', 'pawfriends-core' ) => 'gallery'
							)
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'number_of_columns',
							'heading'     => esc_html__( 'Number of Columns', 'pawfriends-core' ),
							'value'       => array_flip( pawfriends_mikado_get_number_of_columns_array( true ) ),
							'description' => esc_html__( 'Default value is Three', 'pawfriends-core' ),
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Per Page', 'pawfriends-core' ),
							'description' => esc_html__( 'Set number of items for your portfolio list. Enter -1 to show all.', 'pawfriends-core' ),
							'value'       => '-1'
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'image_proportions',
							'heading'     => esc_html__( 'Image Proportions', 'pawfriends-core' ),
							'value'       => array(
								esc_html__( 'Original', 'pawfriends-core' )  => 'full',
								esc_html__( 'Square', 'pawfriends-core' )    => 'square',
								esc_html__( 'Landscape', 'pawfriends-core' ) => 'landscape',
								esc_html__( 'Portrait', 'pawfriends-core' )  => 'portrait',
								esc_html__( 'Medium', 'pawfriends-core' )    => 'medium',
								esc_html__( 'Large', 'pawfriends-core' )     => 'large',
								esc_html__( 'Custom', 'pawfriends-core' )    => 'custom'
							),
							'description' => esc_html__( 'Set image proportions for your portfolio list.', 'pawfriends-core' ),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'gallery' ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'custom_image_width',
							'heading'     => esc_html__( 'Custom Image Width', 'pawfriends-core' ),
							'description' => esc_html__( 'Enter image width in px', 'pawfriends-core' ),
							'dependency'  => array( 'element' => 'image_proportions', 'value' => 'custom' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'custom_image_height',
							'heading'     => esc_html__( 'Custom Image Height', 'pawfriends-core' ),
							'description' => esc_html__( 'Enter image height in px', 'pawfriends-core' ),
							'dependency'  => array( 'element' => 'image_proportions', 'value' => 'custom' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'enable_fixed_proportions',
							'heading'     => esc_html__( 'Enable Fixed Image Proportions', 'pawfriends-core' ),
							'value'       => array_flip( pawfriends_mikado_get_yes_no_select_array( false ) ),
							'description' => esc_html__( 'Set predefined image proportions for your masonry portfolio list. This option will apply image proportions you set in Portfolio Single page - dimensions for masonry option.', 'pawfriends-core' ),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'masonry' ) )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'enable_image_shadow',
							'heading'     => esc_html__( 'Enable Image Shadow', 'pawfriends-core' ),
							'value'       => array_flip( pawfriends_mikado_get_yes_no_select_array( false ) ),
							'save_always' => true
						),
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'category',
							'heading'     => esc_html__( 'One-Category Portfolio List', 'pawfriends-core' ),
							'description' => esc_html__( 'Enter one category slug (leave empty for showing all categories)', 'pawfriends-core' )
						),
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'selected_projects',
							'heading'     => esc_html__( 'Show Only Projects with Listed IDs', 'pawfriends-core' ),
							'settings'    => array(
								'multiple'      => true,
								'sortable'      => true,
								'unique_values' => true
							),
							'description' => esc_html__( 'Delimit ID numbers by comma (leave empty for all)', 'pawfriends-core' )
						),
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'tag',
							'heading'     => esc_html__( 'One-Tag Portfolio List', 'pawfriends-core' ),
							'description' => esc_html__( 'Enter one tag slug (leave empty for showing all tags)', 'pawfriends-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'orderby',
							'heading'     => esc_html__( 'Order By', 'pawfriends-core' ),
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'order',
							'heading'     => esc_html__( 'Order', 'pawfriends-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Item Style', 'pawfriends-core' ),
							'value'      => array(
								esc_html__( 'Standard - Shader', 'pawfriends-core' )                 => 'standard-shader',
								esc_html__( 'Standard - Switch Featured Images', 'pawfriends-core' ) => 'standard-switch-images',
								esc_html__( 'Standard - Gif Overlay', 'pawfriends-core')             => 'standard-gif',
								esc_html__( 'Gallery - Overlay', 'pawfriends-core' )                 => 'gallery-overlay',
								esc_html__( 'Gallery - Slide From Image Bottom', 'pawfriends-core' ) => 'gallery-slide-from-image-bottom'
							),
							'group'      => esc_html__( 'Content Layout', 'pawfriends-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'content_top_margin',
							'heading'    => esc_html__( 'Content Top Margin (px or %)', 'pawfriends-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Bottom Margin (px or %)', 'pawfriends-core' ),
							'dependency' => array( 'element' => 'item_style', 'value' => array( 'standard-shader', 'standard-switch-images' ) ),
							'group'      => esc_html__( 'Content Layout', 'pawfriends-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Title', 'pawfriends-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Title Text Transform', 'pawfriends-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Enable Category', 'pawfriends-core' ),
							'value'      => array_flip( pawfriends_mikado_get_yes_no_select_array( false, true ) ),
							'group'      => esc_html__( 'Content Layout', 'pawfriends-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Number of Images', 'pawfriends-core' ),
							'value'      => array_flip( pawfriends_mikado_get_yes_no_select_array( false, true ) ),
							'dependency' => array( 'element' => 'type', 'value' => array( 'gallery' ) ),
							'group'      => esc_html__( 'Content Layout', 'pawfriends-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Excerpt', 'pawfriends-core' ),
							'value'      => array_flip( pawfriends_mikado_get_yes_no_select_array( false ) ),
							'group'      => esc_html__( 'Content Layout', 'pawfriends-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Excerpt Length', 'pawfriends-core' ),
							'description' => esc_html__( 'Number of characters', 'pawfriends-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Pagination Type', 'pawfriends-core' ),
							'value'      => array(
								esc_html__( 'None', 'pawfriends-core' )            => 'no-pagination',
								esc_html__( 'Standard', 'pawfriends-core' )        => 'standard',
								esc_html__( 'Load More', 'pawfriends-core' )       => 'load-more',
								esc_html__( 'Infinite Scroll', 'pawfriends-core' ) => 'infinite-scroll'
							),
							'group'      => esc_html__( 'Additional Features', 'pawfriends-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'load_more_top_margin',
							'heading'    => esc_html__( 'Load More Top Margin (px or %)', 'pawfriends-core' ),
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'filter',
							'heading'    => esc_html__( 'Enable Category Filter', 'pawfriends-core' ),
							'value'      => array_flip( pawfriends_mikado_get_yes_no_select_array( false ) ),
							'group'      => esc_html__( 'Additional Features', 'pawfriends-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Order By', 'pawfriends-core' ),
							'value'      => array(
								esc_html__( 'Name', 'pawfriends-core' )  => 'name',
								esc_html__( 'Count', 'pawfriends-core' ) => 'count',
								esc_html__( 'Id', 'pawfriends-core' )    => 'id',
								esc_html__( 'Slug', 'pawfriends-core' )  => 'slug'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Filter Text Transform', 'pawfriends-core' ),
							'value'      => array_flip( pawfriends_mikado_get_text_transform_array( true ) ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'pawfriends-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Bottom Margin (px or %)', 'pawfriends-core' ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'pawfriends-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Enable Article Animation', 'pawfriends-core' ),
							'value'       => array_flip( pawfriends_mikado_get_yes_no_select_array( false ) ),
							'description' => esc_html__( 'Enabling this option you will enable appears animation for your portfolio list items', 'pawfriends-core' ),
							'group'       => esc_html__( 'Additional Features', 'pawfriends-core' )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$additional_params['holder_data']          = pawfriends_mikado_get_holder_data_for_cpt( $params, $additional_params );
		...
		$html = pawfriends_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-list', 'portfolio-holder', $params['type'], $params, $additional_params );
	...
	public function getImageSize( $params ) {
		...
		if ( ! empty( $params['image_proportions'] ) && $params['type'] == 'gallery' ) {
			...
			switch ( $image_size ) {
				case 'landscape':
					$thumb_size = 'pawfriends_mikado_image_landscape';
					break;
				case 'portrait':
					$thumb_size = 'pawfriends_mikado_image_portrait';
					break;
				case 'square':
					$thumb_size = 'pawfriends_mikado_image_square';
					break;
				case 'medium':
					$thumb_size = 'medium';
					break;
		...
		if ( $params['type'] == 'masonry' && $params['enable_fixed_proportions'] === 'yes' ) {
			...
			switch ( $fixed_image_size ) {
				...
				case 'large-width-height':
					$thumb_size = 'pawfriends_mikado_image_huge';
					break;
				default :
					$thumb_size = 'full';
					break;
	...
	public function getStandardContentStyles( $params ) {
		...
		if ( ! empty( $margin_top ) ) {
			if ( pawfriends_mikado_string_ends_with( $margin_top, '%' ) || pawfriends_mikado_string_ends_with( $margin_top, 'px' ) ) {
		...
		if ( ! empty( $margin_bottom ) ) {
			if ( pawfriends_mikado_string_ends_with( $margin_bottom, '%' ) || pawfriends_mikado_string_ends_with( $margin_bottom, 'px' ) ) {
	...
	public function getLoadMoreStyles( $params ) {
		...
		if ( ! empty( $params['load_more_top_margin'] ) ) {
			...
			if ( pawfriends_mikado_string_ends_with( $margin, '%' ) || pawfriends_mikado_string_ends_with( $margin, 'px' ) ) {
				$styles[] = 'margin-top: ' . $margin;
			} else {
				$styles[] = 'margin-top: ' . pawfriends_mikado_filter_px( $margin ) . 'px';
			}
		}
	...
	public function getFilterHolderStyles( $params ) {
		...
		if ( ! empty( $params['filter_bottom_margin'] ) ) {
			...
			if ( pawfriends_mikado_string_ends_with( $margin, '%' ) || pawfriends_mikado_string_ends_with( $margin, 'px' ) ) {
				...
				$styles[] = 'margin-bottom: ' . pawfriends_mikado_filter_px( $margin ) . 'px';
			}
		}
	...
	public function getItemLink() {
		...
		return apply_filters( 'pawfriends_mikado_filter_portfolio_external_link', $portfolio_link );
	}
	...
	public function getItemLinkTarget() {
		...
		return apply_filters( 'pawfriends_mikado_filter_portfolio_external_link_target', $portfolio_link_target );
	}
	...
	public function portfolioCategoryAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				...
				$data['label'] = ( ( strlen( $value['portfolio_category_title'] ) > 0 ) ? esc_html__( 'Category', 'pawfriends-core' ) . ': ' . $value['portfolio_category_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $portfolio_category ) ) {
				...
				if ( ! empty( $portfolio_category_title ) ) {
					$portfolio_category_title_display = esc_html__( 'Category', 'pawfriends-core' ) . ': ' . $portfolio_category_title;
				}
	...
	public function portfolioIdAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				$data          = array();
				$data['value'] = $value['id'];
				$data['label'] = esc_html__( 'Id', 'pawfriends-core' ) . ': ' . $value['id'] . ( ( strlen( $value['title'] ) > 0 ) ? ' - ' . esc_html__( 'Title', 'pawfriends-core' ) . ': ' . $value['title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( ! is_wp_error( $portfolio ) ) {
				...
				if ( ! empty( $portfolio_title ) ) {
					$portfolio_title_display = ' - ' . esc_html__( 'Title', 'pawfriends-core' ) . ': ' . $portfolio_title;
				}
				
				$portfolio_id_display = esc_html__( 'Id', 'pawfriends-core' ) . ': ' . $portfolio_id;
	...
	public function portfolioTagAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				$data          = array();
				$data['value'] = $value['slug'];
				$data['label'] = ( ( strlen( $value['portfolio_tag_title'] ) > 0 ) ? esc_html__( 'Tag', 'pawfriends-core' ) . ': ' . $value['portfolio_tag_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $portfolio_tag ) ) {
				...
				if ( ! empty( $portfolio_tag_title ) ) {
					$portfolio_tag_title_display = esc_html__( 'Tag', 'pawfriends-core' ) . ': ' . $portfolio_tag_title;
				}
