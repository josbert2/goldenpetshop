...
$show_related_posts = pawfriends_mikado_options()->getOptionValue('portfolio_single_related_posts') == 'yes';

$post_id = get_the_ID();
$related_posts = pawfriends_core_get_portfolio_single_related_posts($post_id);
?>
