...
namespace PawFriendsCore\CPT;

use PawFriendsCore\Lib;

/**
 * Class PostTypesLoader
 * @package PawFriendsCore\CPT
 */
class PostTypesRegister {
	...
	private function addPostTypes() {
		$cpt_class_name = apply_filters( 'pawfriends_core_filter_register_custom_post_types', $cpt_class_name = array() );
