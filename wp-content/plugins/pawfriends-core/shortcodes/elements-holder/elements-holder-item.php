...
class ElementsHolderItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Elements Holder Item', 'pawfriends-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
                        ...
                        array(
                            ...
                            'dependency' => array('element' => 'background_color', 'not_empty' => true,)
                        ),
						array(
							'type'       => 'attach_image',
						...
						array(
							...
							'heading'     => esc_html__( 'Padding', 'pawfriends-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'pawfriends-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'horizontal_alignment',
							'heading'    => esc_html__( 'Horizontal Alignment', 'pawfriends-core' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Vertical Alignment', 'pawfriends-core' ),
							'value'      => array(
								esc_html__( 'Middle', 'pawfriends-core' ) => 'middle',
								esc_html__( 'Top', 'pawfriends-core' )    => 'top',
								esc_html__( 'Bottom', 'pawfriends-core' ) => 'bottom'
							)
						),
						array(
							'type'       => 'dropdown',
							...
							'value'      => array(
								esc_html__( 'Default (No Animation)', 'pawfriends-core' )   => '',
						...
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 1367px-1600px', 'pawfriends-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. For example 10px 0 10px 0', 'pawfriends-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'pawfriends-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'item_padding_1025_1366',
							'heading'     => esc_html__( 'Padding on screen size between 1025px-1366px', 'pawfriends-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. For example 10px 0 10px 0', 'pawfriends-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'pawfriends-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 768px-1024px', 'pawfriends-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'pawfriends-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'pawfriends-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 680px-768px', 'pawfriends-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'pawfriends-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'pawfriends-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size bellow 680px', 'pawfriends-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'pawfriends-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'pawfriends-core' )
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = pawfriends_core_get_shortcode_module_template_part( 'templates/elements-holder-item-template', 'elements-holder', '', $params );
	...
	private function getHolderClasses( $params ) {
        ...
        $holderClasses[] = ( $params['rounded_corners'] == 'yes' ) ? 'rounded-corners' : '';
