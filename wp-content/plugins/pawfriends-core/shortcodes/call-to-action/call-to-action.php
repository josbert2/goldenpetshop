<?php
namespace PawFriendsCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Call To Action', 'pawfriends-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'pawfriends-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'pawfriends-core' ),
							'value'      => array(
								esc_html__( '80/20', 'pawfriends-core' ) => '80',
								esc_html__( '75/25', 'pawfriends-core' ) => '75',
								esc_html__( '66/33', 'pawfriends-core' ) => '66',
								esc_html__( '50/50', 'pawfriends-core' ) => '50'
							),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'normal' ) )
						),
						array(
						...
						array(
							...
							'heading'     => esc_html__( 'Button Size', 'pawfriends-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Background Color', 'pawfriends-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Hover Background Color', 'pawfriends-core' ),
							'group'      => esc_html__( 'Button Style', 'pawfriends-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_border_color',
							'heading'    => esc_html__( 'Button Border Color', 'pawfriends-core' ),
							'group'      => esc_html__( 'Button Style', 'pawfriends-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_border_color',
							'heading'    => esc_html__( 'Button Hover Border Color', 'pawfriends-core' ),
							'group'      => esc_html__( 'Button Style', 'pawfriends-core' )
						),
						array(
							'type'       => 'textarea_html',
							...
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'pawfriends-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = pawfriends_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
	...
	private function getButtonHolderStyles( $params ) {
		...
		if ( ! empty( $params['button_top_margin'] ) && $params['layout'] === 'simple' ) {
			$styles[] = 'margin-top: ' . pawfriends_mikado_filter_px( $params['button_top_margin'] ) . 'px';
		}
