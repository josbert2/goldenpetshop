<?php
namespace PawFriendsCore\CPT\Shortcodes\ClientsGrid;
...
class ClientsGrid implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if(function_exists('vc_map')) {
			vc_map(
				array(
					'name'      => esc_html__( 'Clients Grid', 'pawfriends-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Items Horizontal Alignment', 'pawfriends-core' ),
							'value'       => array(
								esc_html__( 'Default Center', 'pawfriends-core' ) => '',
						...
						array(
							...
							'heading'     => esc_html__( 'Items Hover Animation', 'pawfriends-core' ),
							'value'       => array(
								esc_html__( 'Switch Images', 'pawfriends-core' ) => 'switch-images',
								esc_html__( 'Roll Over', 'pawfriends-core' )     => 'roll-over'
							),
							'save_always' => true
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = pawfriends_core_get_shortcode_module_template_part( 'templates/clients-grid', 'clients-grid', '', $params );
