<?php
namespace PawFriendsCore\CPT\Shortcodes\ImageGallery;
...
class ImageGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image Gallery', 'pawfriends-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Gallery Type', 'pawfriends-core' ),
							'value'       => array(
								esc_html__( 'Image Grid', 'pawfriends-core' ) => 'grid',
								esc_html__( 'Masonry', 'pawfriends-core' )    => 'masonry',
								esc_html__( 'Slider', 'pawfriends-core' )     => 'slider',
								esc_html__( 'Carousel', 'pawfriends-core' )   => 'carousel'
							),
							'save_always' => true,
							'admin_label' => true
						),
						array(
							'type'        => 'attach_images',
							'param_name'  => 'images',
							'heading'     => esc_html__( 'Images', 'pawfriends-core' ),
							'description' => esc_html__( 'Select images from media library', 'pawfriends-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'image_size',
							'heading'     => esc_html__( 'Image Size', 'pawfriends-core' ),
							'description' => esc_html__( 'Enter image size. Example: thumbnail, medium, large, full or other sizes defined by current theme. Alternatively enter image size in pixels: 200x100 (Width x Height). Leave empty to use "full" size', 'pawfriends-core' )
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'    => esc_html__( 'Image Behavior', 'pawfriends-core' ),
							'value'      => array(
								esc_html__( 'None', 'pawfriends-core' )             => '',
								esc_html__( 'Open Lightbox', 'pawfriends-core' )    => 'lightbox',
								esc_html__( 'Open Custom Link', 'pawfriends-core' ) => 'custom-link',
								esc_html__( 'Zoom', 'pawfriends-core' )             => 'zoom',
								esc_html__( 'Grayscale', 'pawfriends-core' )        => 'grayscale'
							)
						),
						array(
							'type'        => 'textarea',
							'param_name'  => 'custom_links',
							'heading'     => esc_html__( 'Custom Links', 'pawfriends-core' ),
							'description' => esc_html__( 'Delimit links by comma', 'pawfriends-core' ),
							'dependency'  => array( 'element' => 'image_behavior', 'value' => array( 'custom-link' ) )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'custom_link_target',
							'heading'    => esc_html__( 'Custom Link Target', 'pawfriends-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Padding', 'pawfriends-core' ),
							'description' => esc_html__( 'Padding left and right on stage (can see neighbours).', 'pawfriends-core' ),
							'value'       => array_flip( pawfriends_mikado_get_yes_no_select_array( false ) ),
							'save_always' => true,
	...
	public function render( $atts, $content = null ) {
		...
		$html = pawfriends_core_get_shortcode_module_template_part( 'templates/' . $params['type'], 'image-gallery', '', $params );
